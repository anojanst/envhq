CREATE TABLE "project_keys" (
	...
	CONSTRAINT "project_keys_project_id_subject_user_id_uq" UNIQUE("project_id","subject_user_id")
);
...
CREATE INDEX "project_keys_project_id_idx" ON "project_keys" USING btree ("project_id");